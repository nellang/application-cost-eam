...
console.log(this.editData);
    ...
    if (this.application.dateTo < Date()){this.application.type="has-been"}
      else  if (this.application.dateFrom > Date()){this.application.type="to-be"}
        else {this.application.type="as-is"};
}
